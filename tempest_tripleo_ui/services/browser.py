...
class InvalidWebdriverSetting(TempestException):
    message = "Invalid webdriver: {}. Should be either 'Chrome' or 'Firefox'"
...
def get_browser():
    ...
    if browser_driver.lower() == "chrome":
        ...
        raise InvalidWebdriverSetting(browser_driver)
