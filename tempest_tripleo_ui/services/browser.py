...
def get_browser():
    ...
    browser_driver = None
    try:
        browser_driver = CONF.ui.webdriver
    except Exception as e:
        logger.error(e)
        return None
    logger.error("hi")
    logger.error("get_browser(): driver name is '{}'".format(browser_driver))
    ...
    browser = Browser(browser_factory, CONF.ui.homepage)
    return browser
